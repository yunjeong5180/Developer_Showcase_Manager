      ...
      <div class="container">
        <div class="contact-grid">
          <div class="contact-card">
            ...
            <a href="mailto:yunjeong5180@naver.com" class="contact-link"
              >이메일 보내기</a
            >
          </div>
          ...
          <div class="contact-card">
            ...
            <a
              href="https://github.com/yang-yoonjeong"
              target="_blank"
              class="contact-link"
              >GitHub 보기</a
            >
          ...
          <div class="contact-card">
            ...
            <a
              href="https://linkedin.com/in/yang-yoonjeong"
              target="_blank"
              class="contact-link"
              >LinkedIn 보기</a
            >
    ...
    <section class="message-section">
      <div class="container">
        ...
        <p class="section-subtitle">
          궁금하신 점이 있거나 함께 일할 기회가 있다면 언제든지 연락주세요!
          최대한 빠르게 답변드리겠습니다.
        </p>
        ...
        <div class="message-form-container">
          <div class="form-left">
            ...
            <h3>선호 연락 방법</h3>
            <p class="contact-preference">이메일 또는 폼 메시지</p>
      ...
      faqs: [
        {
          ...
          answer:
            "네, 현재 새로운 프로젝트와 협업 기회를 열어두고 있습니다. 프로젝트의 규모와 일정에 따라 참여 가능 여부가 결정됩니다.",
        },
        {
          question: "어떤 기술 스택을 주로 사용하시나요?",
          answer:
            "프론트엔드는 HTML, CSS, JavaScript, Vue.js를 주로 사용하고, 백엔드는 Java, Spring Boot를 사용합니다. 또한 Git으로 버전 관리를 하고 있습니다.",
        },
        {
          question: "응답은 얼마나 빨리 받을 수 있나요?",
          answer:
            "보통 24시간 이내에 답변드리려고 노력하고 있습니다. 주말이나 공휴일의 경우 조금 더 시간이 걸릴 수 있습니다.",
        },
        {
          question: "원격 근무가 가능한가요?",
          answer:
            "네, 원격 근무가 가능합니다. 프로젝트의 성격에 따라 유연하게 대응할 수 있습니다.",
        },
      ],
    };
  },
