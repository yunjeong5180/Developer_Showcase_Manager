    ...
    <div v-else-if="user" class="max-w-6xl mx-auto px-6 py-12">
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
        <div class="flex flex-col md:flex-row items-center gap-8">
          <div
            class="w-32 h-32 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full flex items-center justify-center"
          >
            <img
      ...
      >
        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          >
            <div
              class="h-40 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg mb-4"
            >
              <img
