...
export const projectAPI = {
  ...
  async getProjects(filters = {}) {
    try {
      ...
      let query = supabase
        .from("projects")
        .select(
          "id, title, description, tech_stack, github_url, demo_url, image_urls, start_date, end_date, is_featured, view_count, created_at, updated_at",
          { count: "exact" }
        )
  ...
  async updateProject(projectId, updateData) {
    try {
      ...
      if (updateData.tech_stack !== undefined)
        updatePayload.tech_stack = updateData.tech_stack || [];
      if (updateData.github_url !== undefined)
        updatePayload.github_url = updateData.github_url?.trim() || null;
      if (updateData.demo_url !== undefined)
        updatePayload.demo_url = updateData.demo_url?.trim() || null;
      if (updateData.image_urls !== undefined)
        updatePayload.image_urls = updateData.image_urls || [];
      if (updateData.start_date !== undefined)
        updatePayload.start_date = updateData.start_date || null;
      if (updateData.end_date !== undefined)
        updatePayload.end_date = updateData.end_date || null;
      if (updateData.is_featured !== undefined)
        updatePayload.is_featured = updateData.is_featured;
...
export const getProjects = projectAPI.getProjects.bind(projectAPI);
export const getProject = projectAPI.getProject.bind(projectAPI);
...
export const logActivity = projectAPI.logActivity.bind(projectAPI);
